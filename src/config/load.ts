...
export function toTickConfig(config: Config): TickConfig {
  ...
  return {
    ...
    signalTrendBoost: config.scoring.signalTrendBoost,
    entitySignalWeight: config.scoring.entitySignalWeight,
    signalHistoryDays: config.retention.signalHistoryDays,
