...
"executive editor" output. Generated by the Opus tier only for the most significant
Stories.
...
**Reasoner** — the LLM tier. *Haiku* does the cheap high-volume work (classification
